...
def create_app()->FastAPI:
    ...
    app.include_router(auth_router); app.include_router(admin_router); app.include_router(backup_router); app.include_router(data_router); app.include_router(database_router); app.include_router(scheduler_router); app.include_router(router)
